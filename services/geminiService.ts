...
2. Nasleduje sekcia: "**NAJPRV OPRAVA ✅**" kde prepíšeš pôvodný text a v *kurzíve* (použi jednoduché hviezdičky, napr. *slovo*) zvýrazni každú jednu zmenu, ktorú si urobil.
...
4. Nasleduje sekcia: "**EXTRA PRÍLOHA 🍟**", kde navrhneš vylepšený text. 
   ...
   DÔLEŽITÉ: Zmeň maximálne 50 % už opraveného textu (zo sekcie NAJPRV OPRAVA ✅). Nesmie to byť úplne nový text, ale citeľne vylepšený a prirodzenejšie znejúci variant.
